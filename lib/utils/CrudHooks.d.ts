...
export declare class CrudHooks<CreateParams, UpdateParams extends {
    ...
    useListQuery({ filters, ordering, limit }?: ListParams, options?: WithAdditionalQueryKeyPart<QueryOptions<ListResponse>>): import("react-query").UseQueryResult<ListResponse, unknown>;
    usePaginatedListQuery({ filters, ordering, limit }?: ListParams, options?: WithAdditionalQueryKeyPart<QueryOptions<InfiniteData<PaginatedListResponse<ListResponse>>>>): import("react-query").UseInfiniteQueryResult<PaginatedListResponse<ListResponse>, unknown>;
}
export {};
